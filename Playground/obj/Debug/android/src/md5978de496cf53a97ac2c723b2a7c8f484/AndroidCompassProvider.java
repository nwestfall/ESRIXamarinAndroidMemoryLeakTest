...
public class AndroidCompassProvider
	extends md5978de496cf53a97ac2c723b2a7c8f484.CompassProvider
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.Location.AndroidCompassProvider, Esri.ArcGISRuntime, Version=100.2.1.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", AndroidCompassProvider.class, __md_methods);
	}


	public AndroidCompassProvider ()
	{
		super ();
		if (getClass () == AndroidCompassProvider.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.Location.AndroidCompassProvider, Esri.ArcGISRuntime, Version=100.2.1.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", "", this, new java.lang.Object[] {  });
	}
