package md58f40a8d05e9311c15b7f7310411c2403;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.UI.Controls.MapGLSurfaceView, Esri.ArcGISRuntime, Version=100.2.1.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", MapGLSurfaceView.class, __md_methods);
	}


	public MapGLSurfaceView (android.content.Context p0)
	{
		super (p0);
		if (getClass () == MapGLSurfaceView.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.Controls.MapGLSurfaceView, Esri.ArcGISRuntime, Version=100.2.1.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public MapGLSurfaceView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == MapGLSurfaceView.class)
