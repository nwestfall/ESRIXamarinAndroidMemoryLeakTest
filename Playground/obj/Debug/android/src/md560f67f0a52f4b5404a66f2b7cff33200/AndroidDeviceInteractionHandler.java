...
public class AndroidDeviceInteractionHandler
	extends md560f67f0a52f4b5404a66f2b7cff33200.UserInteractionHandler
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime, Version=100.2.1.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", AndroidDeviceInteractionHandler.class, __md_methods);
	}


	public AndroidDeviceInteractionHandler ()
	{
		super ();
		if (getClass () == AndroidDeviceInteractionHandler.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime, Version=100.2.1.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", "", this, new java.lang.Object[] {  });
	}

	public AndroidDeviceInteractionHandler (md58f40a8d05e9311c15b7f7310411c2403.GeoView p0)
	{
		super ();
		if (getClass () == AndroidDeviceInteractionHandler.class)
